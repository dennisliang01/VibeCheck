"""Hybrid Performance Expert - Static analysis + LLM (GPT-4o)."""

from typing import List
from agents.hybrid_base_agent import HybridBaseAgent, HybridConfig
from agents.performance_expert import PerformanceExpert
...
class HybridPerformanceExpert(HybridBaseAgent):
    """Hybrid Performance Expert. Uses GPT-4o for optimization analysis."""
    ...
    def __init__(self, hybrid_config: HybridConfig = None):
        ...
        self.static_agent = PerformanceExpert()
    ...
    async def _llm_analysis(
        ...
        response = await self.llm_client.analyze(
            prompt=prompt,
            context={"task": "performance_analysis"},
            temperature=0.1,
            max_tokens=4000,
