"""Hybrid Semantics Expert - Static analysis + LLM (GPT-4o)."""

from typing import List
from agents.hybrid_base_agent import HybridBaseAgent, HybridConfig
from agents.semantics_expert import SemanticsExpert
from core.models import CodeFragment, AgentResult, AgentType, ValidationContext
from prompts import SEMANTICS_PROMPT


class HybridSemanticsExpert(HybridBaseAgent):
    """Hybrid Semantics Expert. Uses GPT-4o for naming and semantic clarity."""
    ...
    def __init__(self, hybrid_config: HybridConfig = None):
        ...
        super().__init__(AgentType.SEMANTICS, config)
        self.static_agent = SemanticsExpert()
    ...
    async def _llm_analysis(
        ...
        response = await self.llm_client.analyze(
            prompt=prompt,
            context={"task": "semantics_analysis"},
            temperature=0.1,
            max_tokens=4000,
