"""Hybrid Structural Architect - Static analysis + LLM (Claude 3 Opus)."""

from typing import List
from agents.hybrid_base_agent import HybridBaseAgent, HybridConfig
from agents.structural_architect import StructuralArchitect
from core.models import CodeFragment, AgentResult, AgentType, ValidationContext
from prompts import ARCHITECTURE_ANALYSIS_PROMPT


class HybridStructuralArchitect(HybridBaseAgent):
    """Hybrid Structural Architect. Uses Claude 3 Opus for design/architecture thinking."""
    ...
    def __init__(self, hybrid_config: HybridConfig = None):
        ...
        self.static_agent = StructuralArchitect()
    ...
    async def _llm_analysis(
        ...
        response = await self.llm_client.analyze(
            prompt=prompt,
            context={"task": "architecture_analysis"},
            temperature=0.1,
            max_tokens=4000,
