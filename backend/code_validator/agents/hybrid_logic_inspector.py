"""Hybrid Logic Inspector - Static analysis + LLM (Claude 3.5 Sonnet)."""

from typing import List
from agents.hybrid_base_agent import HybridBaseAgent, HybridConfig
from agents.logic_inspector import LogicInspector
from core.models import CodeFragment, AgentResult, AgentType, ValidationContext
from prompts import LOGIC_ANALYSIS_PROMPT


class HybridLogicInspector(HybridBaseAgent):
    """Hybrid Logic Inspector. Uses Claude 3.5 Sonnet for subtle logical bugs."""
    ...
    def __init__(self, hybrid_config: HybridConfig = None):
        ...
        self.static_agent = LogicInspector()
    ...
    async def _llm_analysis(
        ...
        prompt = LOGIC_ANALYSIS_PROMPT.format(
            code=code_context,
            file_path=file_path,
